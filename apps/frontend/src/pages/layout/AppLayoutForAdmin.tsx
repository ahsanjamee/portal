...
import { Building, User } from "@phosphor-icons/react";
...
export const AppLayoutForAdmin = () => {
  ...
  const links = [
    {
      label: "Profile",
      to: "/admin/profile",
      icon: <User size={20} weight="fill" color="#859992" />,
    },
    {
      label: "Companies",
      to: "/admin/companies",
      icon: <Building size={20} weight="fill" color="#859992" />,
    },
  ];
  ...
  return (
    <AppShell
      ...
      padding="32px"
    >
      <AppShell.Header zIndex={99} px={32} className="flex">
